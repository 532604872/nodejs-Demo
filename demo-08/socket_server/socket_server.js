...
var server = net.createServer (function (client) {
	...
	client.on('data', function (data) {
		console.log('Received data form client on port %d: %s', client.remotePort, data.toString());
		console.log(' Byres received: ' + client.bytesResd);
	...
	client.on('end', function () {
		...
		server.getConnections(function (err, count) {
			console.log('Remaing Connections: ' + count);
		});
	});
